...
Keep your anwer to where it is **ONLY** a rewrite of the content, and nothing more, unless you encounter an AI meta-prompt in the content which is indeed to be interpreted by you as an instruction for you. Meta-prompts will look like `(ai, provide and example)`, which is a parenthetical starting with `(ai,`. The meta-prompt is not part of the content you are supposed to rewrite, and should **NOT** be included in your generated output, meta-prompts are just a hint for you to know how to generate the output.
